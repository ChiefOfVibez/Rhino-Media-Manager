...
public class CollectionsView : Panel
{
    ...
    private void InitializeControls()
    {
        ...
        // Product card grid for products in collection
    ...
    private void OnCollectionSelected(object? sender, EventArgs e)
    {
        ...
        if (_collectionsListBox.SelectedIndex < 0 || _collectionsListBox.SelectedIndex >= collections.Count)
        {
            _selectedCollection = null;
            _renameCollectionButton.Enabled = false;
            _deleteCollectionButton.Enabled = false;
            _productCardGrid.LoadProducts(new List<Product>());
            _collectionNameLabel.Text = "No collection selected";
            return;
        }

        var collection = collections[_collectionsListBox.SelectedIndex];
    ...
    private void LoadCollectionProducts(Collection collection)
    {
        ...
        _productCardGrid.LoadProducts(collectionProducts);
    }
