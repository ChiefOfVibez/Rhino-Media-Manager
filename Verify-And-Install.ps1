...
# This script checks file dates and installs with verification

Write-Host "=== Bosch Media Browser - Verification & Install ===" -ForegroundColor Cyan
Write-Host ""
...
# Reset panel state to prevent auto-opening
Write-Host "=== Resetting Panel State ===" -ForegroundColor Cyan
